...
class Parser:
    ...
    def main(self):
        ...
        print('key')
        print('categories')
        channel_id = DataLoader("12DONCMKhLcjcJ1aNJDBcyVUlp28mrMtOl6Rooj3OAok", 'config').read_backlog_scan_ids()
        ...
        print('get_all_data')
        DataLoader("12DONCMKhLcjcJ1aNJDBcyVUlp28mrMtOl6Rooj3OAok", 'config').write_backlog_scan_data(channel_data)
        print('write_backlog_scan_data')
